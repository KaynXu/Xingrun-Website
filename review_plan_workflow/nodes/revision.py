...
def _revision_message(
    *,
    ...
    sections = [
        ...
        "如果课堂材料缺 topic/knowledge_points，不要让计划失败；改成基于 subject/grade/user_requirements 的通用复习或待确认主题，并在 assumptions 写清“课堂主题需老师确认”。",
        "弱素材修订目标：保留可打印题目、可执行清单和完整 days；把未经证实的具体知识点从“课堂事实”改成“待确认复习范围/通用练习范围”。",
