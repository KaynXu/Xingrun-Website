...
require_text "$RUNBOOK" "PDF And LaTeX Render Stability" "PDF and LaTeX render stability section"
require_text "$RUNBOOK" "tests.test_wrong_question_library_pdf tests.test_ai_processor_prompt" "Python PDF and LaTeX proof command"
require_text "$RUNBOOK" "src/wrong-question-latex.test.ts" "frontend LaTeX proof command"
require_text "$RUNBOOK" "src/render-wrong-question-library-pdf.test.ts" "student library PDF render proof command"
require_text "$RUNBOOK" "src/render-wrong-question-practice-sheet-pdf.test.ts" "practice sheet PDF render proof command"
