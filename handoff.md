...
### 当前状态
- 2026-05-04 已按用户确认方向写入“每周错题跟进助手”设计稿：`docs/superpowers/specs/2026-05-04-weekly-wrong-question-followup-design.md`。本方案放弃小程序主动订阅消息推送，改为老师端每周按班级查看学生错题、AI 生成更像老师真人微信的家长沟通话术、一键复制、单个学生错题本 PDF 打开/下载，以及本班所有学生错题本 PDF zip 合集下载。第一版明确不做家长已读、学生打卡、自动群发和复杂提醒规则。
