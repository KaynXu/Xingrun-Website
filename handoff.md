...
- 如果继续按 Ralph 模式处理网站前端稳定性，下一步从 `scripts/ralph/prd.json` 的 `FE-STAB-004` 开始，只做一个 story，验证通过后再把该 story 标记为 `passes=true` 并提交。
