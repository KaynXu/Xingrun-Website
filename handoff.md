...
### 下一步
- 如果继续这一项，下一步就是执行 `docs/superpowers/plans/2026-04-14-consultation-remarks-list-implementation.md`，在 `ConsultationPage` 里把 `follow_up_note` 并入现有信息块，并用源码断言锁住“不新增备注列、不引入横向滚动”的约束。
