...
ENV_VAR_MAP = {
    ...
    "class_commentary_graph_auto_map_enabled": "XR_CLASS_COMMENTARY_GRAPH_AUTO_MAP_ENABLED",
...
DEFAULTS = {
    ...
    "class_commentary_graph_auto_map_enabled": True,
...
def get_runtime_config() -> dict:
    ...
    cfg["class_commentary_graph_auto_map_enabled"] = normalize_bool_flag(
        cfg.get("class_commentary_graph_auto_map_enabled")
    )
