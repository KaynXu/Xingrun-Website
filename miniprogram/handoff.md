...
## 当前状态
- 2026-05-03 已写入“小程序家长上传 2.0 稳定性”Ralph PRD：当前活跃文件是项目根目录 `scripts/ralph/prd.json`，范围锁定家长上传丝滑度、bridge/网站任务交互、轮询恢复、失败可见、错题本/PDF 刷新和生产 smoke；下一条 story 是 `MP-UPLOAD-002 Add explicit parent upload stage feedback`。
