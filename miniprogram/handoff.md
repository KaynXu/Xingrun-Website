...
## 当前状态
- 2026-05-03 当前活跃“小程序家长上传 2.0 稳定性”Ralph PRD 在项目根目录 `scripts/ralph/prd.json`；`MP-UPLOAD-001` 到 `MP-UPLOAD-004` 已完成，下一条 story 是 `MP-UPLOAD-005 Smooth manual crop and box interaction`。
