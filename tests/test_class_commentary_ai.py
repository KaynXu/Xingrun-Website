...
class ClassCommentaryAiTest(unittest.TestCase):
    ...
    def test_payload_contains_roster_transcript_skill_and_output_rules(self):
        ...
        self.assertIn("not optional decoration", output_rules)
        self.assertIn("at least one bracket-style emoji", output_rules)
        self.assertIn("each student's feedback", output_rules)
    ...
    def test_generate_class_commentary_feedback_uses_plain_text_contract(self):
        ...
        self.assertIn("not optional decoration", messages[0]["content"])
        self.assertIn("each student's feedback", messages[0]["content"])
