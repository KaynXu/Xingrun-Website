    ...
    def test_phase_one_v3_schema_columns_are_exact(self):
        expected_columns = {
            ...
            "class_commentary_generations": {
                ...
                "batch_response_snapshot_json",
                "batch_response_hash",
                "batch_validation_snapshot_json",
                "batch_validation_hash",
                "batch_charge_status",
    ...
    def test_structured_feedback_columns_are_additive_with_safe_defaults(self):
        expected_defaults = {
            "class_commentary_generations": {
                ...
                "batch_validation_snapshot_json": "'{}'",
                "batch_validation_hash": "''",
                "batch_charge_status": "'pending'",
                "batch_provider_dispatch_status": "'legacy_unknown'",
