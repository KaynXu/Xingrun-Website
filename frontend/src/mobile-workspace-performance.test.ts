...
test('workspace shell disables wait-mode page transitions and heavy blur on mobile', () => {
  ...
  assert.match(source, /className="sticky top-0 z-10 flex h-20 items-center justify-end border-b border-sky-100\/80 bg-white\/92 px-4 sm:bg-white\/78 sm:backdrop-blur-xl/);
